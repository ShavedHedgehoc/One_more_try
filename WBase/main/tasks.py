...
#                                         )
#                                         new_material_obj.material_name = one_row[
#                                             "product"
#                                         ]["name"]
#                                         new_material_obj.save()
#                                     except new_material_obj.DoesNotExist:
...
#                 try:
#                     new_batch_obj, new_batch_status = Batch_pr.objects.get_or_create(
...
#                 (
#                     new_declared_batches_obj,
#                     new_declared_batches_status,
#                 ) = Declared_Batches.objects.get_or_create(
#                     batch_pr=new_batch_obj,
#                     material=new_material_obj,
#                     decl_quant=one_row["quant"],
#                 )
#                 if new_declared_batches_status:
#                     count += 1
#         else:
#             print("No responce from server...")
#         if count > 0:
    ...
    try:
        ...
        if status == 200:
            ...
            for one_row in table_rows["value"]:
                ...
                # seek_row_count = Declared_Batches.objects.filter(
                #     batch_pr__batch_name=one_row["batch"],
                #     material__code=one_row["code"],
                #     decl_quant=one_row["quant"],
                # ).count()
